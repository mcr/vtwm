...
DoMoveWindowOnDesktop(int x, int y)
{
  ...
  if (moving_window != Scr->VirtualDesktopDScreen)
  {
    if (x + (moving_twindow->frame_width + 2*moving_twindow->frame_bw) > Scr->VirtualDesktopWidth)
      x = Scr->VirtualDesktopWidth - (moving_twindow->frame_width + 2*moving_twindow->frame_bw);
    if (y + (moving_twindow->frame_height + 2*moving_twindow->frame_bw) > Scr->VirtualDesktopHeight)
      y = Scr->VirtualDesktopHeight - (moving_twindow->frame_height + 2*moving_twindow->frame_bw);
  }
...
EndMoveWindowOnDesktop(void)
{
  ...
  else
  {
    ...
    if (moving_x != starting_x || moving_y != starting_y)
    {
      ...
      if (moving_twindow->virtual_frame_x + (moving_twindow->frame_width + 2*moving_twindow->frame_bw) > Scr->VirtualDesktopWidth)
	moving_twindow->virtual_frame_x = Scr->VirtualDesktopWidth - (moving_twindow->frame_width + 2*moving_twindow->frame_bw);
      if (moving_twindow->virtual_frame_y + (moving_twindow->frame_height + 2*moving_twindow->frame_bw) > Scr->VirtualDesktopHeight)
	moving_twindow->virtual_frame_y = Scr->VirtualDesktopHeight - (moving_twindow->frame_height + 2*moving_twindow->frame_bw);
